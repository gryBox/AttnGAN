...
Forked pytorch implementation for reproducing AttnGAN results in the paper [AttnGAN: Fine-Grained Text to Image Generation
...
- `guild.yml` file to run and benchmark algorithm runs (pretrain, train, eval) as a program.
    - See [guild.ai](https://guild.ai/) for full feature set.
